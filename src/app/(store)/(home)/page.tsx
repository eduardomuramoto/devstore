...
const [highlightedProduct, ...otherProducts]  = await getFeaturedProducts()
  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-row-6 gap-6" >
      ...
      <Image className="group-hover:scale-105 transition-transform duration-500" src={highlightedProduct.image} width={920} height={920} quality={100} alt=""/>
   ...
   {otherProducts.map(product => {
    return (
      ...
      <Image className="group-hover:scale-105 transition-transform duration-500" src={product.image} width={920} height={920} quality={100} alt=""/>
